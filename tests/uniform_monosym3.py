...
# Secciones
sect1 = ISection_MS(h=0.3, bf1=0.2, bf2=0.15, tw=0.01, tf1=0.015, tf2=0.015, r1=0.01, r2=0.01) #[m]
...
plot_buckling_mode_3d(model, stabi.mu_crs, stabi.modes, imode=0, scale=0.1, n_sec=3)
